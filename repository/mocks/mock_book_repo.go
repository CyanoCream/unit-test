...
func NewBookRepo(ctrl *gomock.Controller) *MockBookRepo {
...
// CreatBook mocks base method
func (m *MockBookRepo) CreateBook(arg0 model.Books) (model.Books, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookRepo) GetBookByID(arg0 int64) (model.Books, error) {
	m.ctrl.T.Helper()
...
// GeBookByID indicates an expected call of GetBookByID
...
func (m *MockBookRepo) UpdateBook(arg0 model.Books) (model.Books, error) {
	m.ctrl.T.Helper()
